...
export default class ManagerPage extends React.Component<Props> {
  ...
  render() {
    ...
    const changelogUrl: ?string = getConfigProperty(
      "application.changelog_url",
    );
    const docsUrl: ?string = getConfigProperty("application.docs_url");
    const supportEmail: ?string = getConfigProperty(
          ...
          <footer className="manager-footer">
            <div className="container">
              <ul className="list-inline text-center text-muted">
                {changelogUrl && (
                  <li>
                    <a href={changelogUrl}>{this.messages("changelog")}</a>
                  </li>
                )}
                {docsUrl && (
                  <li>
                    <a href={docsUrl}>{this.messages("guide")}</a>
                  </li>
                )}
                {supportEmail && (
                  <li>
              ...
              <p className="text-center text-muted">
                ...
                <a href="https://www.itule.com">ITULE</a>
              </p>
            </div>
          </footer>
        </PageContent>
