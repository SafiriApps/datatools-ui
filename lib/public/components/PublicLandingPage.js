...
export default class PublicLandingPage extends Component<Props> {
  ...
  render() {
    ...
    const logoLarge =
      getConfigProperty("application.logo_large") || DEFAULT_LOGO;
    return (
            ...
            >
              ...
              {!isModuleEnabled("enterprise") && (
                <p>
                  ...
                  <a href="https://www.itule.com">{this.messages("here")}</a>.
                </p>
              )}
              <p>
                {!this.props.user.profile ? (
                  <span>
                    {this.messages("existingUsers")}{" "}
                    <Link to="/login">{this.messages("signInHere")}</Link>.
                  </span>
                ) : null}
              </p>
            </Col>
        ...
        <footer className="landing-footer">
          <div className="container">
            <p className="text-center text-muted">
              <span
                role="img"
                title={this.messages("copyright")}
                aria-label="copyright"
              >
                &copy;
              </span>{" "}
              <a href="https://www.safiri.app/">ITULE</a>
            </p>
          </div>
        </footer>
      </PublicPage>
